...
/**
 * Servlet implementation class deleteStudentInClass
 */
@WebServlet("/project/Menu/deleteStudentInClass")
public class deleteStudentInClass extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String s_number = request.getParameter("Sid");//考生编号
		...
		String sql3 = "delete from joins where t_number = '"+t_number+"' and r_number = '"+r_number+"' and stest_time = '"+time+"' and s_number = '"+s_number+"'";
		try{
			state = Conn.dbConn.createStatement();
